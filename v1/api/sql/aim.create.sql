...
USE AIM
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'auth') EXEC sys.sp_executesql N'CREATE SCHEMA [auth]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'dbo') EXEC sys.sp_executesql N'CREATE SCHEMA [dbo]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'his') EXEC sys.sp_executesql N'CREATE SCHEMA [his]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'mail') EXEC sys.sp_executesql N'CREATE SCHEMA [mail]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'mse') EXEC sys.sp_executesql N'CREATE SCHEMA [mse]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'om') EXEC sys.sp_executesql N'CREATE SCHEMA [om]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'api') EXEC sys.sp_executesql N'CREATE SCHEMA [api]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'fn') EXEC sys.sp_executesql N'CREATE SCHEMA [fn]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'omv') EXEC sys.sp_executesql N'CREATE SCHEMA [omv]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'shop') EXEC sys.sp_executesql N'CREATE SCHEMA [shop]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'cfg') EXEC sys.sp_executesql N'CREATE SCHEMA [cfg]'
GO
IF NOT EXISTS (SELECT * FROM sys.schemas WHERE name = N'item') EXEC sys.sp_executesql N'CREATE SCHEMA [item]'
GO
IF OBJECT_ID('[auth].[app]') IS NULL 
BEGIN 
CREATE TABLE [auth].[app]
(
	 [id] INT NOT NULL IDENTITY(1,1)
	,[uid] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_app_uid] DEFAULT(newid())
	,[src] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[appName] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[isprinter] BIT NULL
	,[sql] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[srcphp] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[hostID] INT NULL
	,[secretUID] UNIQUEIDENTIFIER NULL CONSTRAINT [DF_app_secretID] DEFAULT(newid())
	,[name] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[userID] INT NULL
	,[clientID] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_app] PRIMARY KEY CLUSTERED([uid] ASC)
)

END

IF OBJECT_ID('[auth].[appprintqueue]') IS NULL 
BEGIN 
CREATE TABLE [auth].[appprintqueue]
(
	 [aid] INT NOT NULL IDENTITY(1,1)
	,[uid] UNIQUEIDENTIFIER NULL
	,[href] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[createDt] DATETIME NULL CONSTRAINT [DF_appprintqueue_createDt] DEFAULT(getdate())
	,[printDt] DATETIME NULL
	,[documentname] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[html] TEXT COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_appprintqueue] PRIMARY KEY CLUSTERED([aid] ASC)
)

END

IF OBJECT_ID('[auth].[blacklist]') IS NULL 
BEGIN 
...
IF OBJECT_ID('[auth].[host]') IS NULL 
BEGIN 
CREATE TABLE [auth].[host]
(
	 [id] INT NOT NULL
	,[uid] UNIQUEIDENTIFIER NULL CONSTRAINT [DF_host_uid] DEFAULT(newid())
	,[active] BIT NULL
	,[siteId] INT NULL
	,[domainId] INT NULL
	,[pageId] INT NULL
	...
	,[baseColor] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[mailAccountAid] INT NULL
	,[email] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[emailName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[companyId] INT NULL
	,[backgroundcolor] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[bannercolor] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[bannerimage] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[bannerinnerimage] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[bannerheight] INT NULL
	,[logoimage] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[favicon] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[style] TEXT COLLATE Latin1_General_CI_AS NULL
	,[colorTop] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[colorBackground] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[colorHover] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[colorHyperlink] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[analytics] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[theme] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[sitesoftware] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[nosite] BIT NULL
	,[menuitems] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[config] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[configDb] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[domain] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[ownerId] INT NULL
	,[createdDt] DATETIME NULL
	,[factuurEmail] VARCHAR(100) COLLATE Latin1_General_CI_AS NULL
	,[adres] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[debnr] INT NOT NULL IDENTITY(1,1)
	,[iban] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[companyname] VARCHAR(100) COLLATE Latin1_General_CI_AS NULL
	,[companyinfo] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[js] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[css] TEXT COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_itemSite] PRIMARY KEY CLUSTERED([id] ASC)
)

CREATE NONCLUSTERED INDEX [IX_host] ON [auth].[host]([domain] ASC)

CREATE NONCLUSTERED INDEX [IX_host_name] ON [auth].[host]([name] ASC)

END

IF OBJECT_ID('[auth].[hostDomain]') IS NULL 
BEGIN 
CREATE TABLE [auth].[hostDomain]
(
	 [domain] VARCHAR(500) COLLATE Latin1_General_CI_AS NOT NULL
	,[id] INT NULL
	,[aid] INT NOT NULL IDENTITY(1,1)
	, CONSTRAINT [PK_domain] PRIMARY KEY CLUSTERED([domain] ASC)
)

END

IF OBJECT_ID('[auth].[mailAccount]') IS NULL 
BEGIN 
CREATE TABLE [auth].[mailAccount]
(
	 [aid] INT NOT NULL IDENTITY(1,1)
	,[host] VARCHAR(50) COLLATE Latin1_General_CI_AS NOT NULL
	,[username] VARCHAR(250) COLLATE Latin1_General_CI_AS NOT NULL
	,[password] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[name] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[replyTo] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[hostId] INT NULL
	, CONSTRAINT [PK_mailAccount] PRIMARY KEY CLUSTERED([host] ASC, [username] ASC)
)

END

IF OBJECT_ID('[auth].[mailgroupEmail]') IS NULL 
BEGIN 
CREATE TABLE [auth].[mailgroupEmail]
(
	 [mailgroupAid] INT NOT NULL
	,[emailAid] INT NOT NULL
	,[dateStart] DATETIME NULL
	,[dateEnd] DATETIME NULL
	, CONSTRAINT [PK_mailgroupUser_1] PRIMARY KEY CLUSTERED([mailgroupAid] ASC, [emailAid] ASC)
)

END

IF OBJECT_ID('[auth].[mailServer]') IS NULL 
BEGIN 
CREATE TABLE [auth].[mailServer]
(
	 [host] VARCHAR(50) COLLATE Latin1_General_CI_AS NOT NULL
	,[SMTPHost] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[SMTPPort] INT NULL
	,[SMTPSecure] VARCHAR(10) COLLATE Latin1_General_CI_AS NULL
	,[SMTPAuth] VARCHAR(10) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_mailServer] PRIMARY KEY CLUSTERED([host] ASC)
)

END

IF OBJECT_ID('[auth].[token]') IS NULL 
BEGIN 
CREATE TABLE [auth].[token]
(
	 [id] BIGINT NOT NULL
	,[secret] UNIQUEIDENTIFIER NULL
	, CONSTRAINT [PK_token_1] PRIMARY KEY CLUSTERED([id] ASC)
)

END

IF OBJECT_ID('[auth].[userMsg]') IS NULL 
BEGIN 
CREATE TABLE [auth].[userMsg]
(
	 [aid] INT NOT NULL IDENTITY(1,1)
	,[userID] INT NULL
	,[name] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[createdDT] DATETIME NULL CONSTRAINT [DF_userMsg_createDT] DEFAULT(getutcdate())
	,[sendDT] DATETIME NULL
	,[readDT] DATETIME NULL
	,[itemID] INT NULL
	,[createdByID] INT NULL
	, CONSTRAINT [PK_userMsg] PRIMARY KEY CLUSTERED([aid] ASC)
)

END

IF OBJECT_ID('[auth].[users]') IS NULL 
BEGIN 
CREATE TABLE [auth].[users]
(
	 [id] INT NOT NULL
	,[uid] UNIQUEIDENTIFIER NULL CONSTRAINT [DF_users_uid] DEFAULT(newid())
	,[signinDt] DATETIME NULL
	,[signoutDt] DATETIME NULL
	,[signinUid] UNIQUEIDENTIFIER NULL CONSTRAINT [DF_users_signinUid_1] DEFAULT(newid())
	,[signinCode] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[signinRequest] DATETIME NULL
	...
	,[newpassword] NVARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[newpasswordUI] UNIQUEIDENTIFIER NULL
	,[userRef] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[suserid] INT NULL
	,[verified] BIT NULL
	,[listId] INT NULL
	,[detailId] INT NULL
	,[path] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[menu] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[userLevel] TINYINT NULL
	,[voornamen] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[voorletters] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[tussenvoegsel] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[achternaam] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[mobiel] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[telefoon] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[gebdatum] DATE NULL
	,[bedrijf] BIT NULL
	,[organisatie] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[vestiging] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[afdeling] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[functie] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuuradres] BIT NULL
	,[factuurbedrijf] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuuraanhef] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuurstraat] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuurhuisnummer] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuurtoevoeging] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuurpostcode] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuurplaats] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[factuurland] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL CONSTRAINT [DF_users_land1] DEFAULT('NL')
	,[straat] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[nummer] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[toevoeging] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[postcode] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[plaats] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[land] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL CONSTRAINT [DF_itemUser_land] DEFAULT('NL')
	,[iban] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[bic] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[btwnummer] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[kvk] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[betaald] DATETIME NULL
	,[startDt] DATE NULL CONSTRAINT [DF_itemUser_startDt] DEFAULT(getdate())
	,[eindDt] DATE NULL
	,[betaling] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[nieuwsbrief] BIT NULL CONSTRAINT [DF_itemUser_nieuwsbrief] DEFAULT((1))
	,[hold] BIT NULL
	,[holdwhy] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[licentie] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[licweb] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[licaim] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[aanhef] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[userGroupId] INT NULL
	,[relatie] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[aanhef2] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[voornamen2] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[voorletters2] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[tussenvoegsel2] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[achternaam2] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[gebdatum2] DATE NULL
	,[beeindigen] BIT NULL
	,[toelichting] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[googleId] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[linkedinId] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[facebookId] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[bedrag] INT NULL
	,[mse_access_token] TEXT COLLATE Latin1_General_CI_AS NULL
	,[mse_id_token] TEXT COLLATE Latin1_General_CI_AS NULL
	,[mse_refresh_token] TEXT COLLATE Latin1_General_CI_AS NULL
	,[mse_name] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[mse_email] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[host] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[displayName] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[settings] TEXT COLLATE Latin1_General_CI_AS NULL
	,[source] VARCHAR(200) COLLATE Latin1_General_CI_AS NULL
	,[sourceId] INT NULL
	,[phonenumber] VARCHAR(20) COLLATE Latin1_General_CI_AS NULL
	,[newphonenumber] VARCHAR(20) COLLATE Latin1_General_CI_AS NULL
	,[code] CHAR(8) COLLATE Latin1_General_CI_AS NULL
	,[codeCreateDt] DATETIME NULL
	,[phoneVerifiedDt] DATETIME NULL
	,[onlineDt] DATETIME NULL
	,[bericht] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[logboek] TEXT COLLATE Latin1_General_CI_AS NULL
	,[loginCnt] TINYINT NULL
	,[lastLoginTime] DATETIME NULL
	,[keep_me_signed] BIT NULL
	,[createdById] INT NULL
	,[createdDt] DATETIME NULL CONSTRAINT [DF_users_createdDt] DEFAULT(getdate())
	,[emailId] INT NULL
	,[googleToken] VARCHAR(2000) COLLATE Latin1_General_CI_AS NULL
	,[fullName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[givenName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[familyName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[imageUrl] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[newremoteaddressId] INT NULL
	,[itemId] INT NULL
	,[bsn] NVARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_itemUser] PRIMARY KEY CLUSTERED([id] ASC)
)

CREATE NONCLUSTERED INDEX [IX_users] ON [auth].[users]([email] ASC)

END

IF OBJECT_ID('[dbo].[grid]') IS NULL 
BEGIN 
CREATE TABLE [dbo].[grid]
(
	 [gridname] VARCHAR(100) COLLATE Latin1_General_CI_AS NOT NULL
	,[columns] VARBINARY(MAX) NULL
	,[width] INT NULL
	,[height] INT NULL
	, CONSTRAINT [PK_dtGrid] PRIMARY KEY CLUSTERED([gridname] ASC)
)

END

IF OBJECT_ID('[his].[error]') IS NULL 
BEGIN 
CREATE TABLE [his].[error]
(
	 [ts] TIMESTAMP NOT NULL
	,[createDT] DATETIME NULL CONSTRAINT [DF_error_createDT] DEFAULT(getutcdate())
	,[errorNumber] INT NULL
	,[error] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[data] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_error] PRIMARY KEY CLUSTERED([ts] ASC)
)

END

IF OBJECT_ID('[his].[event]') IS NULL 
BEGIN 
CREATE TABLE [his].[event]
(
	 [ts] TIMESTAMP NOT NULL
	,[LogID] INT NOT NULL IDENTITY(1,1)
	,[LogDateTime] DATETIME NULL CONSTRAINT [DF_event_LogDateTime_1] DEFAULT(getutcdate())
	,[Method] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[Step] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[Data] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[Tag] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[ItemID] INT NULL
	,[Path] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_event] PRIMARY KEY CLUSTERED([ts] ASC)
)

END

IF OBJECT_ID('[mail].[queue]') IS NULL 
BEGIN 
...
(
	...
	,[createDt] DATETIME NULL CONSTRAINT [DF_queue_createDt] DEFAULT(getdate())
	,[loadDt] DATETIME NULL
	,[sendDt] DATETIME NULL
	,[readDt] DATETIME NULL
	,[viewDt] DATETIME NULL
	,[openDt] DATETIME NULL
	,[pri] TINYINT NULL
	,[itemId] INT NULL
	,[fromId] INT NULL
	,[sessionId] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[deviceId] VARCHAR(130) COLLATE Latin1_General_CI_AS NULL
	,[hostname] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[username] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[host] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[succes] BIT NULL
	,[reply] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_queue_1] PRIMARY KEY CLUSTERED([aid] ASC)
)

END

IF OBJECT_ID('[mse].[contact]') IS NULL 
BEGIN 
CREATE TABLE [mse].[contact]
(
	 [ID] INT NOT NULL IDENTITY(1,1)
	,[ItemID] INT NULL
	,[UserID] INT NOT NULL
	,[MseID] VARCHAR(800) COLLATE Latin1_General_CI_AS NOT NULL
	,[LastModifiedDateTime] DATETIME NULL
	,[ContactID] INT NULL
	,[DisplayName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_contact] PRIMARY KEY CLUSTERED([ID] ASC)
)

END

IF OBJECT_ID('[mse].[contactsync]') IS NULL 
BEGIN 
CREATE TABLE [mse].[contactsync]
(
	 [itemID] INT NULL
)
...
IF OBJECT_ID('[om].[attributeName]') IS NULL 
BEGIN 
CREATE TABLE [om].[attributeName]
(
	 [id] INT NOT NULL IDENTITY(1,1)
	,[idx] INT NULL
	,[find] BIT NULL
	,[list] BIT NULL
	,[active] BIT NULL
	,[addtofilter] BIT NULL
	,[classId] INT NULL
	,[name] VARCHAR(50) COLLATE Latin1_General_CS_AI NOT NULL
	...
	,[fieldClassId] INT NULL
	,[valmin] TINYINT NULL
	,[valmax] TINYINT NULL
	,[options] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[width] INT NULL
	,[tag] VARCHAR(10) COLLATE Latin1_General_CI_AS NULL
	,[className] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[tablename] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[keyname] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[refname] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[data] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[levelIdx] TINYINT NULL
	,[userField] BIT NULL
	,[hostField] BIT NULL
	,[isProperty] BIT NULL
	, CONSTRAINT [PK_classField] PRIMARY KEY CLUSTERED([id] ASC)
)

CREATE UNIQUE NONCLUSTERED INDEX [IX_field] ON [om].[attributeName]([name] ASC)

END

IF OBJECT_ID('[om].[attributes]') IS NULL 
BEGIN 
...
(
	...
	,[userId] INT NULL CONSTRAINT [DF_itemValues_userId] DEFAULT((0))
	,[hostId] INT NULL CONSTRAINT [DF_itemValues_hostId] DEFAULT((0))
	,[valueId] INT NULL
	,[find] BIT NULL
	,[list] BIT NULL
	,[idx] INT NULL
	,[link] BIT NULL
	,[createdDt] DATETIME NULL CONSTRAINT [DF_fields_createdDt] DEFAULT(getutcdate())
	,[classId] INT NULL
	,[modDt] DATETIME NULL
	,[modUserId] INT NULL
	,[readonly] BIT NULL
	...
	,[page] BIT NULL
	,[type] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[config] TEXT COLLATE Latin1_General_CI_AS NULL
	,[label] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[opties] TEXT COLLATE Latin1_General_CI_AS NULL
	,[groupname] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[configView] TEXT COLLATE Latin1_General_CI_AS NULL
	,[configEdit] TEXT COLLATE Latin1_General_CI_AS NULL
	,[configList] TEXT COLLATE Latin1_General_CI_AS NULL
	,[private] BIT NULL
	,[itemId] INT NULL
	,[kopId] TINYINT NULL
	,[kop] TINYINT NULL
	,[typeId] TINYINT NULL
	,[rights] CHAR(2) COLLATE Latin1_General_CI_AS NULL
	,[www] BIT NULL
	,[deletedDt] DATETIME NULL
	,[groupID] INT NULL
	,[itemfieldID] TINYINT NULL
	,[share] TINYINT NULL
	,[readID] INT NULL
	,[writeID] INT NULL
	,[inheritedID] INT NULL
	,[item_uid] UNIQUEIDENTIFIER NULL
	, CONSTRAINT [PK_itemValues_1] PRIMARY KEY CLUSTERED([aid] ASC)
)

CREATE UNIQUE NONCLUSTERED INDEX [IX_itemValues] ON [om].[attributes]([aid] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_1] ON [om].[attributes]([id] ASC, [fieldId] ASC, [valueId] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_2] ON [om].[attributes]([valueId] ASC, [fieldId] ASC, [id] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_3] ON [om].[attributes]([hostId] ASC, [fieldId] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_4] ON [om].[attributes]([fieldId] ASC, [valueId] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_5] ON [om].[attributes]([id] ASC, [find] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_6] ON [om].[attributes]([userId] ASC, [fieldId] ASC, [valueId] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_7] ON [om].[attributes]([srcId] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_8] ON [om].[attributes]([itemId] ASC)

CREATE NONCLUSTERED INDEX [IX_itemValues_9] ON [om].[attributes]([typeId] ASC)

END

IF OBJECT_ID('[om].[files]') IS NULL 
BEGIN 
CREATE TABLE [om].[files]
(
	 [id] INT NOT NULL IDENTITY(1,1)
	,[hostId] INT NULL
	,[host] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[name] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[type] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[ext] VARCHAR(10) COLLATE Latin1_General_CI_AS NULL
	,[path] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[src] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[srcs] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[lastModifiedDate] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[size] INT NULL
	,[uid] UNIQUEIDENTIFIER NULL
	,[userId] INT NULL
	,[folder] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[itemId] INT NULL
	,[idx] INT NULL
	,[filename] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[pngSmall] VARBINARY(MAX) NULL
	,[width] INT NULL
	,[height] INT NULL
	,[checkoutDt] DATETIME NULL
	,[username] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[versionIdx] INT NULL
	,[root] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PKitemFile] PRIMARY KEY CLUSTERED([id] ASC)
)

CREATE NONCLUSTERED INDEX [IX_files] ON [om].[files]([itemId] ASC, [uid] ASC)

END

IF OBJECT_ID('[om].[freeid]') IS NULL 
BEGIN 
CREATE TABLE [om].[freeid]
(
	 [id] INT NOT NULL
	, CONSTRAINT [PK_freeid] PRIMARY KEY CLUSTERED([id] ASC)
)

END

IF OBJECT_ID('[om].[hostip]') IS NULL 
BEGIN 
CREATE TABLE [om].[hostip]
(
	 [hostid] INT NOT NULL IDENTITY(1,1)
	,[ip] VARCHAR(50) COLLATE Latin1_General_CI_AS NOT NULL
	,[HTTP_USER_AGENT] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[status] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[city] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[region] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[areaCode] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[dmaCode] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[countryCode] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[countryName] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[continentCode] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[latitude] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[longitude] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[regionCode] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[regionName] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[currencyCode] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[currencySymbol] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[currencySymbol_UTF8] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[currencyConverter] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[country] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[asname] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[isp] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[lat] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[lon] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[org] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[query] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[timezone] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[zip] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	,[company] VARCHAR(250) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_hostip] PRIMARY KEY CLUSTERED([ip] ASC)
)

END

IF OBJECT_ID('[om].[itemFav]') IS NULL 
BEGIN 
CREATE TABLE [om].[itemFav]
(
	 [id] INT NOT NULL
	,[userId] INT NOT NULL
	,[fav] BIT NULL
	,[createdDt] DATETIME NULL CONSTRAINT [DF_itemUser_createdDt] DEFAULT(getdate())
	,[sendMsgDt] DATETIME NULL
	,[createdById] INT NULL
	,[notifiedDt] DATETIME NULL
	,[updateDt] DATETIME NULL
	, CONSTRAINT [PK_itemUser_1] PRIMARY KEY CLUSTERED([id] ASC, [userId] ASC)
)

CREATE NONCLUSTERED INDEX [IX_itemFav] ON [om].[itemFav]([userId] ASC, [id] ASC)

END

IF OBJECT_ID('[om].[itemMsgUser]') IS NULL 
BEGIN 
CREATE TABLE [om].[itemMsgUser]
(
	 [itemMsgAid] INT NOT NULL
	,[userId] INT NOT NULL
	,[itemId] INT NULL
	,[sendEmail] BIT NULL
	,[sendEmailDt] DATETIME NULL
	,[readDt] DATETIME NULL
	,[notifyDt] DATETIME NULL
	,[subject] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	, CONSTRAINT [PK_itemMsgUser] PRIMARY KEY CLUSTERED([itemMsgAid] ASC, [userId] ASC)
)

END

IF OBJECT_ID('[om].[items]') IS NULL 
BEGIN 
CREATE TABLE [om].[items]
(
	 [id] INT NOT NULL IDENTITY(1,1)
	,[detailId] INT NULL
	,[hostId] INT NULL CONSTRAINT [DF_items_hostId] DEFAULT((0))
	,[userId] INT NULL CONSTRAINT [DF_items_userId] DEFAULT((0))
	,[masterId] INT NULL
	,[linkId] INT NULL
	,[srcId] INT NULL
	,[clone] BIT NULL
	...
	,[tblKeyId] INT NULL
	,[idx] INT NULL
	,[classId] INT NULL CONSTRAINT [DF_items_classId] DEFAULT((0))
	,[class] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[inheritedId] INT NULL
	,[derivedId] INT NULL
	,[imageId] INT NULL
	,[name] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[fieldname] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[value] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[states] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[state] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[categorie] VARCHAR(5000) COLLATE Latin1_General_CI_AS NULL
	,[categories] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[description] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[stateId] TINYINT NULL
	,[suserId] INT NULL
	,[uid] UNIQUEIDENTIFIER NULL CONSTRAINT [DF_item_itemUId] DEFAULT(newid())
	,[tag] VARCHAR(100) COLLATE Latin1_General_CI_AS NULL
	,[sourceId] INT NULL
	,[keyId] INT NULL
	,[keyName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[createdDt] DATETIME NULL CONSTRAINT [DF_items_createdDt] DEFAULT(getutcdate())
	...
	,[methodId] INT NULL
	,[subCnt] INT NULL
	,[linkdata] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[levelId] INT NULL
	,[viewCnt] INT NULL
	,[ext] VARCHAR(10) COLLATE Latin1_General_CI_AS NULL
	,[data] VARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL
	,[hasChildren] INT NULL
	,[config] VARCHAR(8000) COLLATE Latin1_General_CI_AS NULL
	,[imgUid] VARCHAR(128) COLLATE Latin1_General_CI_AS NULL
	,[parentId] INT NULL
	,[deleted] BIT NULL
	,[prodId] INT NULL
	,[artId] INT NULL
	,[deletedDate] DATETIME NULL
	,[files] TEXT COLLATE Latin1_General_CI_AS NULL
	,[configList] TEXT COLLATE Latin1_General_CI_AS NULL
	,[configView] TEXT COLLATE Latin1_General_CI_AS NULL
	,[configEdit] TEXT COLLATE Latin1_General_CI_AS NULL
	,[revertToInherited] BIT NULL
	,[adb] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[avw] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[checked] BIT NULL
	,[title] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[subject] VARCHAR(8000) COLLATE Latin1_General_CI_AS NULL
	,[summary] VARCHAR(8000) COLLATE Latin1_General_CI_AS NULL
	,[filterfields] VARCHAR(8000) COLLATE Latin1_General_CI_AS NULL
	,[geolocatie] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[inheritId] INT NULL
	,[createdById] INT NULL
	,[refKey] VARCHAR(50) COLLATE Latin1_General_CI_AS NULL
	,[OwnerId] INT NULL
	,[ResourceId] INT NULL
	,[ResourceTypeId] INT NULL
	,[PlanStartDt] DATETIME NULL
	,[PlanEndDt] DATETIME NULL
	,[Schedule] TEXT COLLATE Latin1_General_CI_AS NULL
	,[Uren] FLOAT NULL
	,[Fixed] BIT NULL
	,[Inzet] TINYINT NULL
	,[Duur] INT NULL
	,[Repeat] BIT NULL
	,[PlanResourceId] INT NULL
	,[Calc] FLOAT NULL
	,[ToGo] FLOAT NULL
	,[filternames] VARCHAR(8000) COLLATE Latin1_General_CI_AS NULL
	,[filtervalues] VARCHAR(8000) COLLATE Latin1_General_CI_AS NULL
	,[fromId] INT NULL
	,[toId] INT NULL
	...
	,[obj] TEXT COLLATE Latin1_General_CI_AS NULL
	,[findtext] TEXT COLLATE Latin1_General_CI_AS NULL
	,[quant] INT NULL
	,[nr] INT NULL
	,[www] BIT NULL
	,[stock] INT NULL
	...
	,[msrp] FLOAT NULL
	,[cp] FLOAT NULL
	,[childClassNr] INT NULL
	,[classNr] INT NULL
	,[activeCnt] INT NULL CONSTRAINT [DF_items_activeCnt] DEFAULT((0))
	,[values] TEXT COLLATE Latin1_General_CI_AS NULL
	,[typeID] INT NULL
	...
	,[writeID] INT NULL
	,[typicalID] INT NULL
	,[tagName] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[ts] TIMESTAMP NULL
	,[indexDT] DATETIME NULL
	,[icon] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[parentFolderId] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[sourceObjectId] VARCHAR(500) COLLATE Latin1_General_CI_AS NULL
	,[secret] UNIQUEIDENTIFIER NULL
	,[server] UNIQUEIDENTIFIER NULL
	,[secret_uid] UNIQUEIDENTIFIER NULL
	, CONSTRAINT [PK_itemItemId] PRIMARY KEY CLUSTERED([id] ASC)
)

CREATE NONCLUSTERED INDEX [IX_item_masterId] ON [om].[items]([masterId] ASC, [idx] ASC)

CREATE NONCLUSTERED INDEX [IX_item_detailId] ON [om].[items]([detailId] ASC)

CREATE NONCLUSTERED INDEX [IX_item_InheritedFromId] ON [om].[items]([inheritedId] ASC)

CREATE NONCLUSTERED INDEX [IX_item_classId] ON [om].[items]([classId] ASC, [id] ASC)

CREATE NONCLUSTERED INDEX [IX_item_Modified] ON [om].[items]([modifiedDt] ASC)

CREATE NONCLUSTERED INDEX [IX_itemUI] ON [om].[items]([uid] ASC)

CREATE NONCLUSTERED INDEX [IX_name] ON [om].[items]([name] ASC)

CREATE NONCLUSTERED INDEX [IX_items] ON [om].[items]([linkId] ASC)

CREATE NONCLUSTERED INDEX [IX_items_1] ON [om].[items]([sourceId] ASC, [classId] ASC, [keyId] ASC)

CREATE NONCLUSTERED INDEX [IX_items_2] ON [om].[items]([classId] ASC, [refKey] ASC)

CREATE NONCLUSTERED INDEX [IX_items_3] ON [om].[items]([classId] ASC, [name] ASC)

CREATE NONCLUSTERED INDEX [IX_items_4] ON [om].[items]([toId] ASC)

CREATE NONCLUSTERED INDEX [IX_items_5] ON [om].[items]([fromId] ASC)

CREATE NONCLUSTERED INDEX [IX_items_6] ON [om].[items]([classId] ASC, [keyName] ASC)

CREATE NONCLUSTERED INDEX [IX_items_7] ON [om].[items]([srcId] ASC)

END

IF OBJECT_ID('[om].[itemUserVisit]') IS NULL 
BEGIN 
CREATE TABLE [om].[itemUserVisit]
(
	 [id] INT NOT NULL
	,[userId] INT NOT NULL
	,[sentDt] DATETIME NULL
	,[firstvisitDt] DATETIME NULL
	,[lastvisitDt] DATETIME NULL
	,[cnt] INT NULL
	,[hostID] INT NULL
	, CONSTRAINT [PK_itemUserVisit] PRIMARY KEY CLUSTERED([id] ASC, [userId] ASC)
)

CREATE NONCLUSTERED INDEX [IX_itemUserVisit] ON [om].[itemUserVisit]([userId] ASC, [id] ASC)

END

IF OBJECT_ID('[om].[itemWord]') IS NULL 
BEGIN 
CREATE TABLE [om].[itemWord]
(
	 [wordID] INT NOT NULL
	,[itemID] INT NOT NULL
	,[cnt] TINYINT NULL
	,[weight] TINYINT NULL
	, CONSTRAINT [PK_wordItem] PRIMARY KEY CLUSTERED([wordID] ASC, [itemID] ASC)
)

END

IF OBJECT_ID('[om].[msg]') IS NULL 
BEGIN 
CREATE TABLE [om].[msg]
(
	 [aid] INT NOT NULL IDENTITY(1,1)
	...
	,[msg] TEXT COLLATE Latin1_General_CI_AS NULL
	,[files] TEXT COLLATE Latin1_General_CI_AS NULL
	,[createdDt] DATETIME NULL CONSTRAINT [DF_msg_createdDt] DEFAULT(getdate())
	, CONSTRAINT [PK_msg_2] PRIMARY KEY CLUSTERED([aid] ASC)
)

END

IF OBJECT_ID('[om].[msgTo]') IS NULL 
BEGIN 
CREATE TABLE [om].[msgTo]
(
	 [aid] INT NOT NULL IDENTITY(1,1)
	,[msgAid] INT NOT NULL
	,[toId] INT NOT NULL
	...
	,[readDt] DATETIME NULL
	,[notifyDt] DATETIME NULL
	, CONSTRAINT [PK_msgTo] PRIMARY KEY CLUSTERED([aid] ASC)
)

END

IF OBJECT_ID('[om].[word]') IS NULL 
BEGIN 
CREATE TABLE [om].[word]
(
	 [word] VARCHAR(50) COLLATE Latin1_General_CI_AS NOT NULL
	,[id] INT NOT NULL IDENTITY(1,1)
	,[ln] TINYINT NULL
	, CONSTRAINT [PK_word_1] PRIMARY KEY CLUSTERED([word] ASC)
)

END

IF OBJECT_ID('[om].[wordSyn]') IS NULL 
BEGIN 
CREATE TABLE [om].[wordSyn]
(
	 [wordID] INT NOT NULL
	,[synID] INT NOT NULL
	, CONSTRAINT [PK_wordSyn] PRIMARY KEY CLUSTERED([wordID] ASC, [synID] ASC)
)
